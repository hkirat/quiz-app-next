    ...
    if (!submitted) {
        return <div>
            <div className="flex items-center justify-center h-screen bg-gray-100">
                ...
                <div className="mb-8">
                    <h1 className="mb-2 text-2xl font-semibold text-slate-600">
                ...
                <div className="mb-8">
                    <input
                        className="w-64 p-2 text-center border-2 border-purple-600 rounded-lg shadow-sm focus:outline-none focus:border-purple-800"
                ...
                <button
                    className="w-64 py-2 text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-opacity-50"
                    style={{ fontSize: "1rem" }}
                    onClick={() => {
                        setSubmitted(true);
                    }}
